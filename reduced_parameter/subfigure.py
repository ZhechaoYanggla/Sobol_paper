...
axs[0].plot(t,V6,'r',alpha=0.7, label=r'$p_{\text{Clb}} + p_{\text{Kr}} + p_{\text{K1}} + p_{\text{CaL}} + p_{\text{NaCa}} + p_{\text{Ks}}$', linewidth=lw)
axs[0].plot(t,V7,'y',alpha=0.7,label=r'+$p_{\text{NaK}}$', linewidth=lw)
axs[0].plot(t,V8,color='tab:orange',alpha=0.7,  label=r'+$p_{\text{tos}}$', linewidth=lw)
axs[0].plot(t,V9,'g',alpha=0.7, label= r'+$p_{\text{ClCa}}$', linewidth=lw)
axs[0].plot(t,V10, color='tab:gray',alpha=0.7,  label=r'+$p_{\text{Cab}}$', linewidth=lw)
axs[0].plot(t,V11, color='tab:brown',alpha=0.7,  label=r'+$p_{\text{tof}}$', linewidth=lw)
axs[0].plot(t,V12,'m',alpha=0.7,label=r'+$p_{\text{Cap}}$', linewidth=lw)
axs[0].plot(t,V13,'c',alpha=0.7,  label=r'+$p_{\text{Nab}}$',linewidth=lw)
axs[0].plot(t,V14,'b',alpha=0.7, label=r'+$p_{\text{Na}}$',linewidth=lw)
axs[0].plot(t,V15,'k',alpha=0.7, label = r'+$p_{\text{Kp}}$' ,linewidth=lw,linestyle='--')



axs[0].set_xlabel('t [ms]', fontsize =12)
...
axs[1].set_xlabel('t [ms]', fontsize =12)
axs[1].set_ylabel('[Ca$^{2+}]_{i}$ [mM]', fontsize =12)
...
axs[2].set_xlabel('BCL [ms]', fontsize =12)
axs[2].set_ylabel('A$_{90}$ [ms]', fontsize =12)
